...
test('renders content', () => {
  ...
  render(<Blog blog={blog} handlelike={() => addLike(blog.id)} handledelete={() => deleteBlog(blog)} user={user} bloguser={user} />)
...
test('clicking like button twice', async () => {
  ...
  render(<Blog blog={blog} handleLike={mockHandler} handledelete={() => deleteBlog(blog)} user={user} bloguser={user}/>)
  const appUser = userEvent.setup()
